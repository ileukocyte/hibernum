...
group = "io.ileukocyte"
version = Version(major = 2, minor = 3, stability = Version.Stability.ReleaseCandidate)
...
dependencies {
    // Discord
    implementation(group = "net.dv8tion", name = "JDA", version = "4.4.0_352") { exclude(module = "opus-java") }
