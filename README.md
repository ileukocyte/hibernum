# hibernum
**Hibernum** is a modern Discord multi-purpose 100% [Kotlin](https://kotlinlang.org/)-coded bot that relies on its musical functionality, utility commands, and fun module.
